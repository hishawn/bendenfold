...
if ( !class_exists( 'avia_sc_promobox_1' ) )
{
	class avia_sc_promobox_1 extends aviaShortcodeTemplate
	{
			/**
			...
			{
				$this->config['name']			= __('PPC Promo 1', 'avia_framework' );
//				$this->config['tab']		= __('Content Elements', 'avia_framework' );
				...
				$this->config['shortcode'] 		= 'ppc_promobox';
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$output = "";
				$output.= "	<div class='av_promobox ppc_promo ppc_promo_1 ".$this->class_by_arguments('button' , $atts, true).$meta['el_class']."'>";
