...
if ( !class_exists( 'avia_sc_image_1' ) )
{
	class avia_sc_image_1 extends aviaShortcodeTemplate
	{
			/**
			...
			{
				$this->config['name']			= __('PPC Image', 'avia_framework' );
//				$this->config['tab']		= __('Content Elements', 'avia_framework' );
				...
				$this->config['shortcode'] 		= 'ppc_image';
