...
if ( !class_exists( 'avia_sc_iconlist_1' ) )
{
	class avia_sc_iconlist_1 extends aviaShortcodeTemplate
	{
			/**
			...
			{
				$this->config['name']		= __('PPC Icon List', 'avia_framework' );
//				$this->config['tab']		= __('Content Elements', 'avia_framework' );
				...
				$this->config['shortcode'] 	= 'ppc_iconlist';
				$this->config['shortcode_nested'] = array('ppc_iconlist_item');
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$output	 = "";
				$output .= "<div id='ppc-icon-list' class='avia-icon-list-container ".$meta['el_class']."'>";
			...
			function ppc_iconlist_item($atts, $content = "", $shortcodename = "")
			{
