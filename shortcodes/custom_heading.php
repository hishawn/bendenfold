...
if ( !class_exists( 'ppc_heading' ) ) 
{
	class ppc_heading extends aviaShortcodeTemplate{
			...
			{
				$this->config['name']		= __('PPC Heading', 'avia_framework' );
//				$this->config['tab']		= __('Content Elements', 'avia_framework' );
				...
				$this->config['shortcode'] 	= 'ppc_heading';
			...
			function editor_element($params)
			{
				...
				$params['class'] = "";
				$params['innerHtml']  = "<div class='avia_textblock avia_textblock_style avia-special-heading ppc-heading' >";
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
        		...
        		if($heading)
        		{
	        		...
	        		if(!empty($subheading_active) && !empty($content))
	        		{
	        			...
	        			$content = "<div class ='ppc-subheading av-subheading av-{$subheading_active}' style='font-size:{$subheading_size}px;'>".ShortcodeHelper::avia_apply_autop(ShortcodeHelper::avia_remove_autop($content) )."</div>";
	        		...
	        		//html markup
	        		$output .= "<div id='ppc-heading'>";

	        		$output .= "<div {$styling} class='av-special-heading av-special-heading-{$tag} {$color} {$style} {$class}'>";
	        		$output .= 		$before;
	        		$output .= 		"<{$tag} class='ppc-heading av-special-heading-tag' $markup>{$heading}</{$tag}>";
	        		$output .= 		$after;
