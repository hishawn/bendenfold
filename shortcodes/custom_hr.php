...
if ( !class_exists( 'avia_sc_hr_1' ) ) 
{
	class avia_sc_hr_1 extends aviaShortcodeTemplate{
			...
			{
				$this->config['name']		= __('PPC Separator', 'avia_framework' );
//				$this->config['tab']		= __('Content Elements', 'avia_framework' );
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
        		...
        		$output .= "<div id='ppc-hr' {$style} class='hr hr-{$class} ".$meta['el_class']."'><span class='custom-hr hr-inner'><span class='hr-inner-style'></span></span></div>";
