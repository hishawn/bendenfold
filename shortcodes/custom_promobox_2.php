...
if ( !class_exists( 'avia_sc_promobox_2' ) )
{
	class avia_sc_promobox_2 extends aviaShortcodeTemplate
	{
			/**
			...
			{
				$this->config['name']			= __('PPC Promo 2', 'avia_framework' );
//				$this->config['tab']		= __('Content Elements', 'avia_framework' );
				...
				$this->config['shortcode'] 		= 'ppc_promobox_1';
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$output = "";
				$output.= "	<div class='av_promobox ppc_promo ppc_promo_2 ".$this->class_by_arguments('button' , $atts, true).$meta['el_class']."'>";
