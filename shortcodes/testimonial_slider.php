...
if ( !class_exists( 'avia_sc_content_slider_1' ) )
{
  class avia_sc_content_slider_1 extends aviaShortcodeTemplate
  {
			/**
			...
			{
				$this->config['name']			= __('PPC Testimonial Slider', 'avia_framework' );
//				$this->config['tab']		= __('Content Elements', 'avia_framework' );
				$this->config['tab']		= __('PPC Elements', 'avia_framework' );
				$this->config['icon']			= AviaBuilder::$path['imagesURL']."sc-contentslider.png";
				$this->config['order']			= 85;
				$this->config['target']			= 'avia-target-insert';
				$this->config['shortcode'] 		= 'ppc_content_slider';
				$this->config['shortcode_nested'] = array('ppc_content_slide');
				$this->config['tooltip'] 	    = __('Display a custom testimonials slider', 'avia_framework' );
			}
			...
			function popup_elements()
			{
				$this->elements = array(
					...
					array(
						...
						"desc" 	=> __("Check if the slider should rotate by default",'avia_framework' ),
						"id" 	=> "autoplay",
						"type" 	=> "select",
						"std" 	=> "false",
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$slider  = new ppc_content_slider($atts);
				return $slider->html();
			}
...
if ( !class_exists( 'ppc_content_slider' ) )
{
	class ppc_content_slider
	{
		...
		public function html()
		{
            ...
            $thumb_fallback = "";
            $output .= "<div {$data} class='testimonial-slider-container avia-content-slider-element-container avia-content-slider-element-{$type} avia-content-slider avia-smallarrow-slider avia-content-{$type}-active avia-content-slider".ppc_content_slider::$slider." avia-content-slider-{$total} {$class}' >";
...
//				$output .= "</div>";
                ...
                foreach($content as $key => $value)
                {
                    ...
                    $output .= "<section class='testimonial-slider-slide slide-entry flex_column {$post_class} {$grid} {$extraClass}' $markup>";
				...
				$output .= "<div class='testimonial-slider-arrows'>";
	//				$output .= "<div class='new-special-heading'>".$heading."</div>";
        ...
        {
            $html  = "";
            $html .= "<div class='testimonial-slider-arrows avia-slideshow-arrows avia-slideshow-controls'>";
        ...
        {
            $html   = "";
            $html  .= "<div class='testimonial-slider-dots avia-slideshow-dots avia-slideshow-controls'>";
            $active = "active";
